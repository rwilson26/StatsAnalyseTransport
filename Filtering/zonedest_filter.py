# Auteur : Rémy Wilson
# Programme : Filtre pour garder les valeurs valides de la colonne 'destreportzone'.
...
input_filename = "filtered_zoneorigin.csv"
output_filename = "filtered_zonedest.csv"
column_to_filter = "destreportzone"
